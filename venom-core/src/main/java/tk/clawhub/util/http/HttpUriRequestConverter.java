...
import tk.clawhub.util.UrlUtils;

import java.util.Map;

/**
 * <Description>Http uri request converter <br>
 *
 * @author LiZhiming<br>
 * @version 1.0<br>
 * @taskId <br>
...
public class HttpUriRequestConverter {
    ...
    /**
     * Convert http client context http client context.
     *
     * @param request the request
     * @param proxy   the proxy
    ...
    /**
     * Convert http uri request http uri request.
     *
     * @param request the request
     * @param site    the site
     * @param proxy   the proxy
    ...
    /**
     * Select request method request builder.
     *
     * @param request the request
    ...
    /**
     * Add form params request builder.
     *
